...
class Gui:
    ...
    def add_pd(self, choice, category, section):
        ...
        if section == "Add_pd":
            ...
            self.btnTR2.config(text='inner', background="dark slate gray",
                               command=lambda: self.add_order_pizza(section))

            self.btnTR3.config(text='outer', background="dark slate gray",
    ...
    def drink(self, choice, section):
        ...
        self.lable_pd.config(text='Amount')
    ...
    def add_order_rice(self, section):
        ...
        self.lable_pd.config(text='outer')
        print(pizza_list[0])
    ...
    def add_order_pizza(self, section):
        ...
        self.lable_pd.config(text='inner')
        print(pizza_list[0])
        length_data = len(pizza_list)
        for i in range(0, length_data):
            t_id = str(pizza_list[i])
    ...
    def add_order_template(self, shop_id):
        ...
        self.lable_pd = tk.Label(self.frameL1, bg='black', text='Medicine',
        ...
        self.editAreaTable2.insert(tk.INSERT, 'Please Select medicine from the left column(medicine use per day)')
    ...
    def my_payment(self):
        ...
        if number in range(0, 121):
            ...
            tk.Label(self.frameL1, bg='black', text=('Credit Card Record'),
                     font=("Helvetica", 20, "bold "), fg="white", borderwidth=5).pack()
    ...
    def main_page(self, section, order_id, table_id):
        ...
        if section == 1:
            tk.Label(self.frameL1, bg='black', text='Clinic list',
                     font=("Helvetica", 20, "bold "), fg="white", borderwidth=5).pack()
        ...
        self.btnTR1.config(text='Order', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.my_order())

        self.btnTR2.config(text='User Account', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.my_account())

        self.btnTR3.config(text='Address', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.my_address())

        self.btnTR4.config(text='Payment', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.my_payment())

        self.btnTR5.config(text='Management', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.Stock_manage())

        self.btnTR6.config(text='Booking', font=("Helvetica", 20, "bold "), bg='forest green',
                           command=lambda: self.book_manage())
    ...
    def __init__(self, root, id):
        ...
        self.root.title("Minson Chinese Clinic")
